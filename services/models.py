...
class Mailing(models.Model):
    ...
    name = models.CharField(
        max_length=150,
        verbose_name="Название", **NULLABLE
        )
    ...
    client = models.ManyToManyField(Client,
        verbose_name='Kлиенты для рассылки')
...
class Logs(models.Model):
    ...
    mailing = models.ForeignKey(Mailing,verbose_name='рассылка',null=True,on_delete=models.SET_NULL)
